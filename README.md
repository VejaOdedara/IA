...
![5](https://github.com/VejaOdedara/IA/assets/136159210/f434097f-4ec7-48c8-a3f0-e70025e0bb18))
...
1. Clone this repository to your local machine:
    ...
    ```bash
    git clone https://github.com/VejaOdedara/IA.git
    ```
...
```bash
docker pull vejaodedara/myvprofileapp
```
## Author

- [Kathan shah](https://github.com/VejaOdedara)
